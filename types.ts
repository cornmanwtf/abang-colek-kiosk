...
export const MENU: MenuItem[] = [
    ...
    { name: "SAMBAL BOX", price: 15.00 },
    { name: "COMBO 5 MIX", price: 75.00, description: "Jumbo Colex, Sambal Box" },
    { name: "COMBO 10 MIX", price: 150.00, description: "Jumbo Colex, Sambal Box, #FREE" }
];
